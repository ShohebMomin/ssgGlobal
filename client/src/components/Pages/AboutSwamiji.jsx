    ...
    <>
      ...
      <section className="md:flex relative md:mb-10 mb-5">
        ...
        <div className="bg-customPurple md:w-2/6">
          <div className="md:w-lg absolute md:top-40 md:right-0.5 md:p-0 p-5 md:rounded-2xl overflow-hidden"><img className="w-full h-full" src="/Images/swamiji.jpg" alt="" /></div>
        </div>
      </section>
