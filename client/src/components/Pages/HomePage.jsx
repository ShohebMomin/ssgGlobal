      ...
      <main>
        ...
        <div id="puja-images-container" className="flex justify-between h-auto px-20  mb-10">
          <div className="puja-image">
            <img width="310" height="360" src="/Images/pujaImage1.jpg" alt="pujaImage" />
          </div>
          <div className="puja-image">
            <img width="310" height="360" src="/Images/pujaImage2.jpg" alt="pujaImage" />
          </div>
          <div className="puja-image">
            <img width="310" height="360" src="/Images/pujaImage3.jpg" alt="pujaImage" />
          </div>
          <div className="puja-image">
            <img width="310" height="360" src="/Images/pujaImage4.jpg" alt="pujaImage" />
          </div>
        ...
        <div id="ashtalakshmi-puja" className="w-full flex justify-center px-10">
          <div className="rounded-2xl mr-5 h-152	 w-136 overflow-hidden object-cover mb-5">
            <img width="530" height="608" src="/Images/ashtalakshmi.jpg" alt="Ashtalakshmi" />
          </div>
