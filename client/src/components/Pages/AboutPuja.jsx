...
const AboutPuja = () => {
  return (
    <>
      <HeroSection textSize="text-xs md:text-5xl" imagesrc="src\assets\Images\aboutpuja.jpg" layout="top-2 md:top-10 left-auto right-5 md:right-10 h-full w-20 md:w-96" heading="Discover the sacred ritual that blesses every aspect of your life with the divine grace of the eight forms of Goddess Lakshmi."/>
...
This puja is ideal for those seeking divine guidance to overcome challenges, achieve success, and bring harmony to their personal and professional lives."/>
       ...
       <main className="mb-10">
          <div className="md:flex  justify-center ashtalakshmi-div">
              ...
              <div className="ashtalakshmi-content-div"><img src="/src/assets/Images/adi-lakshmi.png" alt="" />
              <h2>Adi Lakshmi:</h2>
              <p>Bestows eternal wealth and spiritual strength.</p>
              </div>

              <div className="ashtalakshmi-content-div"><img src="/src/assets/Images/dhan-lakshmi.png" alt="" />
              <h2>Dhana Lakshmi:</h2>
